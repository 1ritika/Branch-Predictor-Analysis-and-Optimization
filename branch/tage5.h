...
#define TAGE_BIMODAL_TABLE_SIZE 32768
...
#define TAGE_MIN_HISTORY_LENGTH 16
#define TAGE_HISTORY_ALPHA 2
#define TAGE_RESET_USEFUL_INTERVAL 512000

const uint8_t TAGE_INDEX_BITS[TAGE_NUM_COMPONENTS] = {14,14,11,11};
const uint8_t TAGE_TAG_BITS[TAGE_NUM_COMPONENTS] = {7,7,11,11};
